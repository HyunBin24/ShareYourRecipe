...
export default function Random() {
  ...
  const data = location.state?.recipeRandom;
    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100dvh", width: "100%", overflow: "hidden", backgroundColor: "#ffffff", boxSizing: "border-box", position: "fixed", top: 0, left: 0 }}>
      ...
      <header style={{
        ...
        <div style={{display: "flex", justifyContent: "center", alignItems: "center", flex: "0 0 auto", padding: "0 10px"}}>
          <span style={{fontSize: "clamp(15px, 3vw, 18px)", fontWeight: "bold", color: "#333", whiteSpace: "nowrap"}}>레시피 뽑기</span>
        </div>
      ...
      <main style={{flex: "1", overflowY: "auto", overflowX: "hidden", width: "100%", boxSizing: "border-box", backgroundColor: "#fff"}}>
        {loading ? (
          ...
          // 레시피 내용
          <div key={recipe.id} style={{display: "flex", flexWrap: "wrap", width: "100%", boxSizing: "border-box", padding: "15px 15px", alignItems: "stretch"}}>
            {/* 제목, 즐겨찾기 */}
            ...
            <div style={{flex: "1 1 350px", padding: "10px", boxSizing: "border-box", display: "flex", flexDirection: "column", justifyContent: "flex-start"}}>
              <div style={{width: "100%", aspectRatio: "4 / 3", overflow: "hidden", borderRadius: "12px", border: "1px solid #f2f2f2", display: "flex", justifyContent: "center", alignItems: "center", backgroundColor: "#f8f9fa" }}>
            ...
            <div style={{flex: "1 1 400px", padding: "10px", boxSizing: "border-box", display: "flex", flexDirection: "column", justifyContent: "flex-start", textAlign: "left"}}>
              <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
                ...
                <div style={{ display: "flex", alignItems: "center" }}>
                  ...
                  <span style={{ fontSize: "clamp(13px, 2.5vw, 15px)", color: "#000" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                  <span style={{ fontWeight: "bold", color: "#888", fontSize: "clamp(13px, 5vw, 15px)" }}>간단 레시피</span>
            ...
            {/* 다시 뽑기 버튼 */}
            <div style={{width: "100%", justifyContent: "right", display: "flex", padding: "10px"}}>
              <button className={styles.redBtn} style={{padding: "10px 30px", boxSizing: "border-box", border: "none", color: "#fff", fontWeight: "bold", fontSize: "clamp(12px, 2vw, 16px)", borderRadius: '8px', cursor: "pointer", margin: 0}} onClick={handleRandom}>
                뭐 먹지?
              </button>
            </div>
          </div>
        ) : (
          <div style={{display: "flex", flexDirection: "column", width: "100%", minHeight: "60vh", justifyContent: "center", alignItems: "center", padding: "15px", boxSizing: "border-box"}}>
            <p style={{fontSize: "clamp(15px, 3vw, 18px)", color: "#888", margin: "0"}}>레시피가 없습니다.</p>
          </div>
        )}
